...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		...
		m->declare("mono.dsp/author", "Yann Orlarey");
		m->declare("mono.dsp/name", "kisana2");
	...
	virtual void instanceConstants(int sample_rate) {
		...
		iConst0 = int((0.166666672f * std::min<float>(192000.0f, std::max<float>(1.0f, float(fSampleRate)))));
		sig0->instanceInitmydspSIG0(sample_rate);
	...
	virtual void instanceClear() {
		...
		for (int l42 = 0; (l42 < 128); l42 = (l42 + 1)) {
			fVec20[l42] = 0.0f;
		}
		...
		for (int l54 = 0; (l54 < 256); l54 = (l54 + 1)) {
			fVec26[l54] = 0.0f;
		}
		...
		for (int l66 = 0; (l66 < 128); l66 = (l66 + 1)) {
			fVec32[l66] = 0.0f;
		}
		...
		for (int l70 = 0; (l70 < 256); l70 = (l70 + 1)) {
			fVec34[l70] = 0.0f;
		}
		...
		for (int l74 = 0; (l74 < 128); l74 = (l74 + 1)) {
			fVec36[l74] = 0.0f;
		}
		...
		for (int l82 = 0; (l82 < 256); l82 = (l82 + 1)) {
			fVec40[l82] = 0.0f;
		}
		...
		for (int l98 = 0; (l98 < 256); l98 = (l98 + 1)) {
			fVec48[l98] = 0.0f;
		}
		...
		for (int l104 = 0; (l104 < 128); l104 = (l104 + 1)) {
			fVec51[l104] = 0.0f;
		}
		...
		for (int l136 = 0; (l136 < 32); l136 = (l136 + 1)) {
			fVec67[l136] = 0.0f;
		}
		...
		for (int l140 = 0; (l140 < 32); l140 = (l140 + 1)) {
			fVec69[l140] = 0.0f;
		}
	...
	virtual void buildUserInterface(UI* ui_interface) {
		...
		ui_interface->addVerticalSlider("level", &fVslider1, 0.0f, 0.0f, 6.0f, 1.0f);
		ui_interface->closeBox();
		ui_interface->openVerticalBox("loop48");
		ui_interface->declare(&fVslider0, "1", "");
		ui_interface->addVerticalSlider("note", &fVslider0, 0.0f, 0.0f, 11.0f, 1.0f);
		ui_interface->closeBox();
		...
		ui_interface->closeBox();
		ui_interface->closeBox();
		ui_interface->declare(&fEntry0, "knob", "1");
		ui_interface->addNumEntry("Volume", &fEntry0, 0.5f, 0.0f, 1.0f, 0.00999999978f);
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		float fSlow0 = (float(fEntry0) * std::pow(10.0f, (0.0500000007f * float(fHslider0))));
		float fSlow1 = float(fHslider1);
		int iSlow2 = (fSlow1 <= 0.0f);
		int iSlow3 = int(float(fVslider0));
		int iSlow4 = (float(iSlow3) <= 0.0f);
		int iSlow5 = int(float(fVslider1));
		int iSlow6 = (float(iSlow5) <= 0.0f);
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			fVec0[0] = fSlow1;
			iRec1[0] = ((iRec1[1] + 1) % iConst0);
			int iTemp0 = (iRec1[0] == 0);
			iVec1[0] = iTemp0;
			int iTemp1 = iVec1[1];
			fRec2[0] = (iTemp1 ? 0.0f : (fRec2[1] + std::fabs((fSlow1 - fVec0[1]))));
			iRec3[0] = ((iTemp0 + iRec3[1]) % 15);
			ftbl0[((iTemp0 & ((fRec2[0] > 0.0f) | iSlow2)) ? iRec3[0] : 15)] = fSlow1;
			...
			iVec2[0] = iSlow3;
			iRec6[0] = (iTemp1 ? 0 : (iRec6[1] + std::abs((iSlow3 - iVec2[1]))));
			ftbl1[((iTemp0 & ((iRec6[0] > 0) | iSlow4)) ? iRec3[0] : 15)] = float(iSlow3);
			float fTemp6 = ftbl1[iRec3[0]];
			int iTemp7 = (std::fabs((fTemp6 + -11.0f)) < 0.5f);
			iVec3[0] = iTemp7;
			fRec5[0] = ((fRec5[1] + float((float((iTemp7 - iVec3[1])) > 0.0f))) - (0.0118651045f * float((fRec5[1] > 0.0f))));
			iVec4[0] = iSlow5;
			iRec7[0] = (iTemp1 ? 0 : (iRec7[1] + std::abs((iSlow5 - iVec4[1]))));
			ftbl2[((iTemp0 & ((iRec7[0] > 0) | iSlow6)) ? iRec3[0] : 15)] = float(iSlow5);
			float fTemp8 = std::pow(10.0f, (0.0500000007f * (ftbl2[iRec3[0]] + -6.0f)));
			fVec5[(IOTA & 127)] = ((0.498352528f * ((fTemp3 * fRec0[1]) + (fTemp4 * fRec0[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec5[0] > 0.0f))) * fTemp8)));
			fRec0[0] = fVec5[((IOTA - 83) & 127)];
			iVec6[0] = iSlow7;
			iRec10[0] = (iTemp1 ? 0 : (iRec10[1] + std::abs((iSlow7 - iVec6[1]))));
			ftbl3[((iTemp0 & ((iRec10[0] > 0) | iSlow8)) ? iRec3[0] : 15)] = float(iSlow7);
			float fTemp9 = ftbl3[iRec3[0]];
			int iTemp10 = (std::fabs((fTemp9 + -11.0f)) < 0.5f);
			iVec7[0] = iTemp10;
			fRec9[0] = ((fRec9[1] + float((float((iTemp10 - iVec7[1])) > 0.0f))) - (0.0237302091f * float((fRec9[1] > 0.0f))));
			fVec8[(IOTA & 63)] = ((0.499175578f * ((fTemp3 * fRec8[1]) + (fTemp4 * fRec8[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec9[0] > 0.0f))) * fTemp8)));
			fRec8[0] = fVec8[((IOTA - 41) & 63)];
			float fTemp11 = (fRec0[0] + fRec8[0]);
			int iTemp12 = (std::fabs((fTemp6 + -10.0f)) < 0.5f);
			iVec9[0] = iTemp12;
			fRec12[0] = ((fRec12[1] + float((float((iTemp12 - iVec9[1])) > 0.0f))) - (0.00997732393f * float((fRec12[1] > 0.0f))));
			fVec10[(IOTA & 127)] = ((0.498041421f * ((fTemp3 * fRec11[1]) + (fTemp4 * fRec11[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec12[0] > 0.0f))) * fTemp8)));
			fRec11[0] = fVec10[((IOTA - 99) & 127)];
			int iTemp13 = (std::fabs((fTemp9 + -10.0f)) < 0.5f);
			iVec11[0] = iTemp13;
			fRec14[0] = ((fRec14[1] + float((float((iTemp13 - iVec11[1])) > 0.0f))) - (0.0199546479f * float((fRec14[1] > 0.0f))));
			fVec12[(IOTA & 63)] = ((0.499019742f * ((fTemp3 * fRec13[1]) + (fTemp4 * fRec13[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec14[0] > 0.0f))) * fTemp8)));
			fRec13[0] = fVec12[((IOTA - 49) & 63)];
			float fTemp14 = (fRec11[0] + fRec13[0]);
			int iTemp15 = (std::fabs((fTemp6 + -9.0f)) < 0.5f);
			iVec13[0] = iTemp15;
			fRec16[0] = ((fRec16[1] + float((float((iTemp15 - iVec13[1])) > 0.0f))) - (0.00888878573f * float((fRec16[1] > 0.0f))));
			fVec14[(IOTA & 127)] = ((0.497802079f * ((fTemp3 * fRec15[1]) + (fTemp4 * fRec15[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec16[0] > 0.0f))) * fTemp8)));
			fRec15[0] = fVec14[((IOTA - 111) & 127)];
			int iTemp16 = (std::fabs((fTemp9 + -9.0f)) < 0.5f);
			iVec15[0] = iTemp16;
			fRec18[0] = ((fRec18[1] + float((float((iTemp16 - iVec15[1])) > 0.0f))) - (0.0177775715f * float((fRec18[1] > 0.0f))));
			fVec16[(IOTA & 63)] = ((0.498899847f * ((fTemp3 * fRec17[1]) + (fTemp4 * fRec17[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec18[0] > 0.0f))) * fTemp8)));
			fRec17[0] = fVec16[((IOTA - 55) & 63)];
			float fTemp17 = (fRec15[0] + fRec17[0]);
			int iTemp18 = (std::fabs((fTemp6 + -8.0f)) < 0.5f);
			iVec17[0] = iTemp18;
			fRec20[0] = ((fRec20[1] + float((float((iTemp18 - iVec17[1])) > 0.0f))) - (0.00747454772f * float((fRec20[1] > 0.0f))));
			fVec18[(IOTA & 255)] = ((0.49738732f * ((fTemp3 * fRec19[1]) + (fTemp4 * fRec19[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec20[0] > 0.0f))) * fTemp8)));
			fRec19[0] = fVec18[((IOTA - 132) & 255)];
			int iTemp19 = (std::fabs((fTemp9 + -8.0f)) < 0.5f);
			iVec19[0] = iTemp19;
			fRec22[0] = ((fRec22[1] + float((float((iTemp19 - iVec19[1])) > 0.0f))) - (0.0149490954f * float((fRec22[1] > 0.0f))));
			fVec20[(IOTA & 127)] = ((0.498691946f * ((fTemp3 * fRec21[1]) + (fTemp4 * fRec21[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec22[0] > 0.0f))) * fTemp8)));
			fRec21[0] = fVec20[((IOTA - 65) & 127)];
			float fTemp20 = (fRec19[0] + fRec21[0]);
			int iTemp21 = (std::fabs((fTemp6 + -7.0f)) < 0.5f);
			iVec21[0] = iTemp21;
			fRec24[0] = ((fRec24[1] + float((float((iTemp21 - iVec21[1])) > 0.0f))) - (0.00665906491f * float((fRec24[1] > 0.0f))));
			fVec22[(IOTA & 255)] = ((0.497068316f * ((fTemp3 * fRec23[1]) + (fTemp4 * fRec23[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec24[0] > 0.0f))) * fTemp8)));
			fRec23[0] = fVec22[((IOTA - 149) & 255)];
			int iTemp22 = (std::fabs((fTemp9 + -7.0f)) < 0.5f);
			iVec23[0] = iTemp22;
			fRec26[0] = ((fRec26[1] + float((float((iTemp22 - iVec23[1])) > 0.0f))) - (0.0133181298f * float((fRec26[1] > 0.0f))));
			fVec24[(IOTA & 127)] = ((0.498531997f * ((fTemp3 * fRec25[1]) + (fTemp4 * fRec25[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec26[0] > 0.0f))) * fTemp8)));
			fRec25[0] = fVec24[((IOTA - 74) & 127)];
			float fTemp23 = (fRec23[0] + fRec25[0]);
			int iTemp24 = (std::fabs((fTemp6 + -6.0f)) < 0.5f);
			iVec25[0] = iTemp24;
			fRec28[0] = ((fRec28[1] + float((float((iTemp24 - iVec25[1])) > 0.0f))) - (0.00593255227f * float((fRec28[1] > 0.0f))));
			fVec26[(IOTA & 255)] = ((0.496710479f * ((fTemp3 * fRec27[1]) + (fTemp4 * fRec27[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec28[0] > 0.0f))) * fTemp8)));
			fRec27[0] = fVec26[((IOTA - 167) & 255)];
			int iTemp25 = (std::fabs((fTemp9 + -6.0f)) < 0.5f);
			iVec27[0] = iTemp25;
			fRec30[0] = ((fRec30[1] + float((float((iTemp25 - iVec27[1])) > 0.0f))) - (0.0118651045f * float((fRec30[1] > 0.0f))));
			fVec28[(IOTA & 127)] = ((0.498352528f * ((fTemp3 * fRec29[1]) + (fTemp4 * fRec29[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec30[0] > 0.0f))) * fTemp8)));
			fRec29[0] = fVec28[((IOTA - 83) & 127)];
			float fTemp26 = (0.707106769f * (fRec27[0] + fRec29[0]));
			int iTemp27 = (std::fabs((fTemp6 + -5.0f)) < 0.5f);
			iVec29[0] = iTemp27;
			fRec32[0] = ((fRec32[1] + float((float((iTemp27 - iVec29[1])) > 0.0f))) - (0.00498866197f * float((fRec32[1] > 0.0f))));
			fVec30[(IOTA & 255)] = ((0.496090502f * ((fTemp3 * fRec31[1]) + (fTemp4 * fRec31[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec32[0] > 0.0f))) * fTemp8)));
			fRec31[0] = fVec30[((IOTA - 199) & 255)];
			int iTemp28 = (std::fabs((fTemp9 + -5.0f)) < 0.5f);
			iVec31[0] = iTemp28;
			fRec34[0] = ((fRec34[1] + float((float((iTemp28 - iVec31[1])) > 0.0f))) - (0.00997732393f * float((fRec34[1] > 0.0f))));
			fVec32[(IOTA & 127)] = ((0.498041421f * ((fTemp3 * fRec33[1]) + (fTemp4 * fRec33[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec34[0] > 0.0f))) * fTemp8)));
			fRec33[0] = fVec32[((IOTA - 99) & 127)];
			float fTemp29 = (fRec31[0] + fRec33[0]);
			int iTemp30 = (std::fabs((fTemp6 + -4.0f)) < 0.5f);
			iVec33[0] = iTemp30;
			fRec36[0] = ((fRec36[1] + float((float((iTemp30 - iVec33[1])) > 0.0f))) - (0.00444439286f * float((fRec36[1] > 0.0f))));
			fVec34[(IOTA & 255)] = ((0.495613843f * ((fTemp3 * fRec35[1]) + (fTemp4 * fRec35[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec36[0] > 0.0f))) * fTemp8)));
			fRec35[0] = fVec34[((IOTA - 224) & 255)];
			int iTemp31 = (std::fabs((fTemp9 + -4.0f)) < 0.5f);
			iVec35[0] = iTemp31;
			fRec38[0] = ((fRec38[1] + float((float((iTemp31 - iVec35[1])) > 0.0f))) - (0.00888878573f * float((fRec38[1] > 0.0f))));
			fVec36[(IOTA & 127)] = ((0.497802079f * ((fTemp3 * fRec37[1]) + (fTemp4 * fRec37[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec38[0] > 0.0f))) * fTemp8)));
			fRec37[0] = fVec36[((IOTA - 111) & 127)];
			float fTemp32 = (fRec35[0] + fRec37[0]);
			int iTemp33 = (std::fabs((fTemp6 + -3.0f)) < 0.5f);
			iVec37[0] = iTemp33;
			fRec40[0] = ((fRec40[1] + float((float((iTemp33 - iVec37[1])) > 0.0f))) - (0.00373727386f * float((fRec40[1] > 0.0f))));
			fVec38[(IOTA & 511)] = ((0.494788289f * ((fTemp3 * fRec39[1]) + (fTemp4 * fRec39[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec40[0] > 0.0f))) * fTemp8)));
			fRec39[0] = fVec38[((IOTA - 266) & 511)];
			int iTemp34 = (std::fabs((fTemp9 + -3.0f)) < 0.5f);
			iVec39[0] = iTemp34;
			fRec42[0] = ((fRec42[1] + float((float((iTemp34 - iVec39[1])) > 0.0f))) - (0.00747454772f * float((fRec42[1] > 0.0f))));
			fVec40[(IOTA & 255)] = ((0.49738732f * ((fTemp3 * fRec41[1]) + (fTemp4 * fRec41[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec42[0] > 0.0f))) * fTemp8)));
			fRec41[0] = fVec40[((IOTA - 132) & 255)];
			float fTemp35 = (fRec39[0] + fRec41[0]);
			int iTemp36 = (std::fabs((fTemp6 + -1.0f)) < 0.5f);
			iVec41[0] = iTemp36;
			fRec44[0] = ((fRec44[1] + float((float((iTemp36 - iVec41[1])) > 0.0f))) - (0.00296627614f * float((fRec44[1] > 0.0f))));
			fVec42[(IOTA & 511)] = ((0.493442565f * ((fRec43[1] * fTemp3) + (fTemp4 * fRec43[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec44[0] > 0.0f))) * fTemp8)));
			fRec43[0] = fVec42[((IOTA - 336) & 511)];
			int iTemp37 = (std::fabs((fTemp9 + -1.0f)) < 0.5f);
			iVec43[0] = iTemp37;
			fRec46[0] = ((fRec46[1] + float((float((iTemp37 - iVec43[1])) > 0.0f))) - (0.00593255227f * float((fRec46[1] > 0.0f))));
			fVec44[(IOTA & 255)] = ((0.496710479f * ((fTemp3 * fRec45[1]) + (fTemp4 * fRec45[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec46[0] > 0.0f))) * fTemp8)));
			fRec45[0] = fVec44[((IOTA - 167) & 255)];
			float fTemp38 = (fRec43[0] + fRec45[0]);
			int iTemp39 = (std::fabs((fTemp6 + -2.0f)) < 0.5f);
			iVec45[0] = iTemp39;
			fRec48[0] = ((fRec48[1] + float((float((iTemp39 - iVec45[1])) > 0.0f))) - (0.00332953245f * float((fRec48[1] > 0.0f))));
			fVec46[(IOTA & 511)] = ((0.494153798f * ((fTemp3 * fRec47[1]) + (fTemp4 * fRec47[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec48[0] > 0.0f))) * fTemp8)));
			fRec47[0] = fVec46[((IOTA - 299) & 511)];
			int iTemp40 = (std::fabs((fTemp9 + -2.0f)) < 0.5f);
			iVec47[0] = iTemp40;
			fRec50[0] = ((fRec50[1] + float((float((iTemp40 - iVec47[1])) > 0.0f))) - (0.00665906491f * float((fRec50[1] > 0.0f))));
			fVec48[(IOTA & 255)] = ((0.497068316f * ((fTemp3 * fRec49[1]) + (fTemp4 * fRec49[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec50[0] > 0.0f))) * fTemp8)));
			fRec49[0] = fVec48[((IOTA - 149) & 255)];
			float fTemp41 = (fRec47[0] + fRec49[0]);
			iVec49[0] = iSlow9;
			iRec53[0] = (iTemp1 ? 0 : (iRec53[1] + std::abs((iSlow9 - iVec49[1]))));
			ftbl4[((iTemp0 & ((iRec53[0] > 0) | iSlow10)) ? iRec3[0] : 15)] = float(iSlow9);
			float fTemp42 = ftbl4[iRec3[0]];
			int iTemp43 = (std::fabs((fTemp42 + -1.0f)) < 0.5f);
			iVec50[0] = iTemp43;
			fRec52[0] = ((fRec52[1] + float((float((iTemp43 - iVec50[1])) > 0.0f))) - (0.0118651045f * float((fRec52[1] > 0.0f))));
			fVec51[(IOTA & 127)] = ((0.498352528f * ((fTemp3 * fRec51[1]) + (fTemp4 * fRec51[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec52[0] > 0.0f))) * fTemp8)));
			fRec51[0] = fVec51[((IOTA - 83) & 127)];
			int iTemp44 = (std::fabs((fTemp42 + -2.0f)) < 0.5f);
			iVec52[0] = iTemp44;
			fRec55[0] = ((fRec55[1] + float((float((iTemp44 - iVec52[1])) > 0.0f))) - (0.0133181298f * float((fRec55[1] > 0.0f))));
			fVec53[(IOTA & 127)] = ((0.498531997f * ((fTemp3 * fRec54[1]) + (fTemp4 * fRec54[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec55[0] > 0.0f))) * fTemp8)));
			fRec54[0] = fVec53[((IOTA - 74) & 127)];
			int iTemp45 = (std::fabs((fTemp42 + -3.0f)) < 0.5f);
			iVec54[0] = iTemp45;
			fRec57[0] = ((fRec57[1] + float((float((iTemp45 - iVec54[1])) > 0.0f))) - (0.0149490954f * float((fRec57[1] > 0.0f))));
			fVec55[(IOTA & 127)] = ((0.498691946f * ((fTemp3 * fRec56[1]) + (fTemp4 * fRec56[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec57[0] > 0.0f))) * fTemp8)));
			fRec56[0] = fVec55[((IOTA - 65) & 127)];
			int iTemp46 = (std::fabs((fTemp42 + -4.0f)) < 0.5f);
			iVec56[0] = iTemp46;
			fRec59[0] = ((fRec59[1] + float((float((iTemp46 - iVec56[1])) > 0.0f))) - (0.0177775715f * float((fRec59[1] > 0.0f))));
			fVec57[(IOTA & 63)] = ((0.498899847f * ((fTemp3 * fRec58[1]) + (fTemp4 * fRec58[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec59[0] > 0.0f))) * fTemp8)));
			fRec58[0] = fVec57[((IOTA - 55) & 63)];
			int iTemp47 = (std::fabs((fTemp42 + -5.0f)) < 0.5f);
			iVec58[0] = iTemp47;
			fRec61[0] = ((fRec61[1] + float((float((iTemp47 - iVec58[1])) > 0.0f))) - (0.0199546479f * float((fRec61[1] > 0.0f))));
			fVec59[(IOTA & 63)] = ((0.499019742f * ((fTemp3 * fRec60[1]) + (fTemp4 * fRec60[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec61[0] > 0.0f))) * fTemp8)));
			fRec60[0] = fVec59[((IOTA - 49) & 63)];
			int iTemp48 = (std::fabs((fTemp42 + -6.0f)) < 0.5f);
			iVec60[0] = iTemp48;
			fRec63[0] = ((fRec63[1] + float((float((iTemp48 - iVec60[1])) > 0.0f))) - (0.0237302091f * float((fRec63[1] > 0.0f))));
			fVec61[(IOTA & 63)] = ((0.499175578f * ((fTemp3 * fRec62[1]) + (fTemp4 * fRec62[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec63[0] > 0.0f))) * fTemp8)));
			fRec62[0] = fVec61[((IOTA - 41) & 63)];
			float fTemp49 = (0.707106769f * fRec62[0]);
			int iTemp50 = (std::fabs((fTemp42 + -7.0f)) < 0.5f);
			iVec62[0] = iTemp50;
			fRec65[0] = ((fRec65[1] + float((float((iTemp50 - iVec62[1])) > 0.0f))) - (0.0266362596f * float((fRec65[1] > 0.0f))));
			fVec63[(IOTA & 63)] = ((0.499265462f * ((fTemp3 * fRec64[1]) + (fTemp4 * fRec64[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec65[0] > 0.0f))) * fTemp8)));
			fRec64[0] = fVec63[((IOTA - 36) & 63)];
			int iTemp51 = (std::fabs((fTemp42 + -8.0f)) < 0.5f);
			iVec64[0] = iTemp51;
			fRec67[0] = ((fRec67[1] + float((float((iTemp51 - iVec64[1])) > 0.0f))) - (0.0298981909f * float((fRec67[1] > 0.0f))));
			fVec65[(IOTA & 63)] = ((0.499345541f * ((fTemp3 * fRec66[1]) + (fTemp4 * fRec66[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec67[0] > 0.0f))) * fTemp8)));
			fRec66[0] = fVec65[((IOTA - 32) & 63)];
			int iTemp52 = (std::fabs((fTemp42 + -9.0f)) < 0.5f);
			iVec66[0] = iTemp52;
			fRec69[0] = ((fRec69[1] + float((float((iTemp52 - iVec66[1])) > 0.0f))) - (0.0355551429f * float((fRec69[1] > 0.0f))));
			fVec67[(IOTA & 31)] = ((0.499449611f * ((fTemp3 * fRec68[1]) + (fTemp4 * fRec68[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec69[0] > 0.0f))) * fTemp8)));
			fRec68[0] = fVec67[((IOTA - 27) & 31)];
			int iTemp53 = (std::fabs((fTemp42 + -10.0f)) < 0.5f);
			iVec68[0] = iTemp53;
			fRec71[0] = ((fRec71[1] + float((float((iTemp53 - iVec68[1])) > 0.0f))) - (0.0399092957f * float((fRec71[1] > 0.0f))));
			fVec69[(IOTA & 31)] = ((0.499509633f * ((fTemp3 * fRec70[1]) + (fTemp4 * fRec70[2]))) + (4.65661287e-10f * ((fTemp5 * float((fRec71[0] > 0.0f))) * fTemp8)));
			fRec70[0] = fVec69[((IOTA - 24) & 31)];
			int iTemp54 = (std::fabs((fTemp42 + -11.0f)) < 0.5f);
			iVec70[0] = iTemp54;
			fRec73[0] = ((fRec73[1] + float((float((iTemp54 - iVec70[1])) > 0.0f))) - (0.0474604182f * float((fRec73[1] > 0.0f))));
			fVec71[(IOTA & 31)] = ((0.499587625f * ((fTemp3 * fRec72[1]) + (fTemp4 * fRec72[2]))) + (4.65661287e-10f * ((float((fRec73[0] > 0.0f)) * fTemp5) * fTemp8)));
			fRec72[0] = fVec71[((IOTA - 20) & 31)];
			output0[i] = FAUSTFLOAT((fSlow0 * (((0.213200718f * fTemp11) + ((0.369274467f * fTemp14) + ((0.4767313f * fTemp17) + ((0.564076066f * fTemp20) + ((0.639602125f * fTemp23) + (fTemp26 + ((0.768706143f * fTemp29) + ((0.825722814f * fTemp32) + ((0.879049063f * fTemp35) + ((0.977008402f * fTemp38) + (0.929320395f * fTemp41))))))))))) + (1.5f * (((((((((((0.977008402f * fRec51[0]) + (0.929320395f * fRec54[0])) + (0.879049063f * fRec56[0])) + (0.825722814f * fRec58[0])) + (0.768706143f * fRec60[0])) + fTemp49) + (0.639602125f * fRec64[0])) + (0.564076066f * fRec66[0])) + (0.4767313f * fRec68[0])) + (0.369274467f * fRec70[0])) + (0.213200718f * fRec72[0]))))));
			output1[i] = FAUSTFLOAT((fSlow0 * (((0.977008402f * fTemp11) + ((0.929320395f * fTemp14) + ((0.879049063f * fTemp17) + ((0.825722814f * fTemp20) + ((0.768706143f * fTemp23) + (fTemp26 + ((0.639602125f * fTemp29) + ((0.564076066f * fTemp32) + ((0.4767313f * fTemp35) + ((0.213200718f * fTemp38) + (0.369274467f * fTemp41))))))))))) + (1.5f * ((((((fTemp49 + (((((0.213200718f * fRec51[0]) + (0.369274467f * fRec54[0])) + (0.4767313f * fRec56[0])) + (0.564076066f * fRec58[0])) + (0.639602125f * fRec60[0]))) + (0.768706143f * fRec64[0])) + (0.825722814f * fRec66[0])) + (0.879049063f * fRec68[0])) + (0.929320395f * fRec70[0])) + (0.977008402f * fRec72[0]))))));
			fVec0[1] = fVec0[0];
			iRec1[1] = iRec1[0];
			iVec1[1] = iVec1[0];
			fRec2[1] = fRec2[0];
