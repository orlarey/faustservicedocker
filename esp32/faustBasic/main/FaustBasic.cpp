/* ------------------------------------------------------------
name: "FaustBasic"
Code generated with Faust 2.19.2 (https://faust.grame.fr)
...
class mydsp : public dsp {
 ...
 public:
	...
	void metadata(Meta* m) { 
		m->declare("filename", "FaustBasic.dsp");
		m->declare("maths.lib/author", "GRAME");
		m->declare("maths.lib/copyright", "GRAME");
		m->declare("maths.lib/license", "LGPL with exception");
		m->declare("maths.lib/name", "Faust Math Library");
		m->declare("maths.lib/version", "2.1");
		m->declare("name", "FaustBasic");
	...
	virtual void buildUserInterface(UI* ui_interface) {
		ui_interface->openVerticalBox("FaustBasic");
	...
	virtual void compute(int count, FAUSTFLOAT** inputs, FAUSTFLOAT** outputs) {
		...
		for (int i = 0; (i < count); i = (i + 1)) {
			...
			float fTemp0 = (fConst1 + (fRec1[1] + -1.0f));
			int iTemp1 = (fTemp0 < 0.0f);
			float fTemp2 = (fConst1 + fRec1[1]);
			fRec1[0] = (iTemp1 ? fTemp2 : fTemp0);
			float fRec2 = (iTemp1 ? fTemp2 : (fConst1 + (fRec1[1] + (fConst2 * fTemp0))));
			float fTemp3 = (fRec0[0] * ((2.0f * fRec2) + -1.0f));
...
FaustBasic::FaustBasic(int sample_rate, int buffer_size)
{
    fBS = buffer_size;
    fDSP = new mydsp();
...
void FaustBasic::setParamValue(const std::string& path, float value)
{
    fUI->setParamValue(path, value);
}

void FaustBasic::configureI2S(int sample_rate, int buffer_size, i2s_pin_config_t pin_config)
{
    #if A1S_BOARD
...
void FaustBasic::audioTaskHandler(void* arg)
{
    FaustBasic* audio = (FaustBasic*)arg;
    audio->audioTask();
}
